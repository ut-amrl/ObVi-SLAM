...
const std::string kPostFrameAddCheckpointOutputFileBaseName = "pose_graph_state_checkpoint_post_frame_add_";
const std::string kPostPostprocessingCheckpointOutputFileBaseName = "pose_graph_state_checkpoint_post_postprocessing_";
