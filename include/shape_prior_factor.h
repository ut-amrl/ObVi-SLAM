#ifndef UT_VSLAM_SHAPE_PRIOR_FACTOR_H
#define UT_VSLAM_SHAPE_PRIOR_FACTOR_H
...
class ShapePriorFactor {
 public:
   ...
   */
  ShapePriorFactor(const Eigen::Vector3f &shape_dim_mean,
...
#endif  // UT_VSLAM_SHAPE_PRIOR_FACTOR_H
