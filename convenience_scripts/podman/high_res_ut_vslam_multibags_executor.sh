...
# TODO change this
config_file_directory=/root/LTOV-SLAM-Evaluation/ut_vslam/config/single_bag_tuning/
# TODO change this
trajectory_sequence_file_directory=/root/LTOV-SLAM-Evaluation/ut_vslam/sequences/single_bag/
