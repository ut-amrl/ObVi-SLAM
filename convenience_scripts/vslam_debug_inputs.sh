...
vslam_in_directory=${VSLAM_IN_DIR}
...
./bin/visualize_vslam_inputs --target_frame_id 233 --debug_output_directory "/robodata/taijing/object-slam/vslam/debug/tmp/" --intrinsics_file ${intrinsics_file} \
