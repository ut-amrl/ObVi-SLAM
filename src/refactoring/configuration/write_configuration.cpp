...
int main(int argc, char **argv) {
  ...
  residual_params_.object_residual_params_
      .object_observation_huber_loss_param_ = 1;
  residual_params_.object_residual_params_
      .shape_dim_prior_factor_huber_loss_param_ = 1;
  residual_params_.object_residual_params_.invalid_ellipsoid_error_val_ = 1e6;
  residual_params_.visual_residual_params_
      .reprojection_error_huber_loss_param_ = 1;
  residual_params_.long_term_map_params_.pair_huber_loss_param_ = 1;

  configuration.ltm_solver_residual_params_ = residual_params_;
  configuration.object_visual_pose_graph_residual_params_ = residual_params_;
  ...
  configuration.bounding_box_front_end_params_ =
      generateBoundingBoxFrontEndParams(
          residual_params_.object_residual_params_, base_solver_params);
