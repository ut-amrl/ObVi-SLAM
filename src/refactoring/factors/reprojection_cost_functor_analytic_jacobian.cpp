...
ReprojectionCostFunctorAnalyticJacobian::
  ...
  Eigen::Quaterniond extrinsics_quat(extrinsics.orientation_);
  cam_rel_bl_vec_ << extrinsics_quat.x(), extrinsics_quat.y(),
      extrinsics_quat.z(), extrinsics_quat.w(), extrinsics.transl_.x(),
      extrinsics.transl_.y(), extrinsics.transl_.z();
